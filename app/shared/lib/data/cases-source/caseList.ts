...
export const defaultCases: CaseItem[] = [
	{
		...
		metrics: ['Конверсия +104%', 'Средний чек +37%', 'Время на сайте +61%'],
		client: 'LuxeDrive',
	},
	{
		id: '2',
	...
	},
	{
		...
		description:
			'От идеи до релиза: DeFi-приложение с интуитивным интерфейсом привлекло 52K+ пользователей за первый месяц.',
	...
	},
	{
		...
		description:
			'Новый интерфейс с игровым интерактивом увеличил частоту заказов на 93% и внедрил NFC-платежи.',
